...
#AD5372.DAC(0, 1)
# AD5372.LDAC()
# QFont('Microsoft YaHei', 12, 100) = QFont()
# QFont('Microsoft YaHei', 12, 100).setBold(True)
...
class DAC(QGroupBox):
    ...
    def createShutters(self):
        ...
        for i in range(len(buttons)):
            ...
            self.shutters[i].setFont(QFont('Microsoft YaHei', 12, 100))
    ...
    def createConfig(self):
        ...
        self.update.setFont(QFont('Microsoft YaHei', 12, 100))
        self.load = QPushButton('Load Data')
        self.load.setFont(QFont('Microsoft YaHei', 12, 100))
        self.save = QPushButton("Save Data")
        self.save.setFont(QFont('Microsoft YaHei', 12, 100))
        hlayout = QHBoxLayout()
...
class RSCtrl(QGroupBox):
    def __init__(self, ip):
        ...
        self.switch.setFont(QFont('Microsoft YaHei', 12, 100))
...
class AD5791Ctrl(QGroupBox):
    def __init__(self, ser="BSPT002144", dll="usb2uis.dll"):
        ...
        self.reset.setFont(QFont('Microsoft YaHei', 12, 100))
        self.level = QPushButton("High")
        self.level.setCheckable(True)
        self.level.setChecked(True)
        self.level.setFont(QFont('Microsoft YaHei', 12, 100))
        self.level.setStyleSheet("background-color: green")
        self.connection = QPushButton("Connect")
        self.connection.setFont(QFont('Microsoft YaHei', 12, 100))
        layout = QHBoxLayout()
...
class Window(QWidget):
    ...
    def create_func(self):
        ...
        self.load_ion.setFont(QFont('Microsoft YaHei', 12, 100))
        ...
        self.monitor.setFont(QFont('Microsoft YaHei', 12, 100))
        ...
        self.laser.setFont(QFont('Microsoft YaHei', 12, 100))
